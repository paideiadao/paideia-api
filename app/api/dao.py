                        ...
                        try:
                            edit_dao(
                                ...
                                CreateOrUpdateDao(
                                    ...
                                    if "im.paideia.dao.url" in dao_config and any(c not in "QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm1234567890" for c in dao_config["im.paideia.dao.url"])
                                    else state_daos[d][0],
                                    dao_key=d,
